...
- 工作台：集中展示今日任务、复习提醒、专题进度、本周刷题、最近复盘、薄弱提醒和备考热力图。
...
4. 从工作台顶部按顺序使用：`制定今日计划`、`记录刷题`、`新增错题`、`新建复盘`、`开始复习`。
5. 如果还没有真实数据，可以执行 `Create Example Data` 体验完整流程。
...
- 图片错题需要用户自行提供图片；插件负责保存附件和遮挡复习区域。
