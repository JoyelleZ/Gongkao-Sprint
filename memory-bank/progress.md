...
- Added lightweight mobile support:
  ...
  - Error-card image preview now supports lightweight left/right rotation, enlarged crop modal with dashed drag selection, contrast-level slider adjustment, and grayscale conversion before saving.
